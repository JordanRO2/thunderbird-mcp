...
// In the DDD layout these pure helpers live in security_helpers.js (consumed by
// mail_service.js via ctx), so the test requires them directly instead of
// extracting a marker-delimited snippet out of the monolithic api.js.
const {
  parseAttachmentPartsFromRawMime,
  attachmentSaveLooksWrong,
} = require("../extension/mcp_server/security_helpers.js");
